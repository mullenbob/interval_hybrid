...
fprintf(out,' GA_sen solution min %15.10e max %15.10e  fvalue min %15.10e  time %s cpu time %f function evals %d\n', min(x),max(x),fval,toc,cputime-starttime,iii);
...
fprintf(out,' GA_sen solution min %15.10e max %15.10e  fvalue max %15.10e  time %s cpu time %f function evals %d\n', min(x),max(x),-fval,toc,cputime-starttime,iii);
