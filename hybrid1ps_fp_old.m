...
fprintf(out,' particle swarm solution min %15.10e max %15.10e  fvalue min %15.10e  time %s  cputime %f  function evals %d\n', min(x(1)),max(x(1)),fval/10000,toc,cputime-starttime,iii);
